...
interface DynamicTableProps {
  ...
  isFetching?: boolean;
  isLoading?: boolean;
  currentPage: number; // Add currentPage to know which page we are on
  pageSize: number; // Add pageSize to set records per page
}
  ...
  return (
    <div className={`overflow-x-auto ${className}`}>
...

      {
        ...
        ) : // If not loading/fetching and there are no users, show "No user found."
